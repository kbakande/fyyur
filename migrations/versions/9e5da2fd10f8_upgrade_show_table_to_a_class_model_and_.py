"""upgrade show table to a class model and change the table names of Artist and Venue model

Revision ID: 9e5da2fd10f8
Revises: a54f6a425eae
Create Date: 2020-07-13 03:16:48.691324
...
revision = '9e5da2fd10f8'
down_revision = 'a54f6a425eae'
branch_labels = None
depends_on = None
